//! Conversions between [`chrono::DateTime<Utc>`] (used by the domain) and
//! [`jiff::Timestamp`] (toasty's wire type).
...
///
/// # Errors
/// Returns `Err(Error::TimeConversion)` if the seconds-plus-nanos pair is
...
///
/// # Errors
/// Returns `Err(Error::TimeConversion)` on out-of-range or invalid
/// component values.
