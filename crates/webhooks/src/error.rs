//! Crate error type for the Webhooks bounded context.
//!
//! Layered like other workspace error enums:
//!
//! - **Domain validation**: `EmptyString`, `InvariantViolated`.
//! - **Persistence**: `Toasty`, `InvalidPersistedValue`, `TimeConversion`.
//! - **HTTP**: `Validation` (400), `NotFound` (404), `Json` (400).
//!
//! [`PartialEq`] / [`Eq`] hold for test ergonomics.

use axum::http::StatusCode;
use axum::response::{IntoResponse, Response};

/// Errors produced by Webhooks operations.
